...
- [opus-503-pkix-is-gateway-cert](opus-503-pkix-is-gateway-cert.md) — icode/opus 503 "PKIX path validation failed: validity check failed" is a McKesson gateway backend-cert problem, not a router bug. Isolate via an open…
